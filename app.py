...
gunicorn
pytest
✅ 3. Jenkins Pipeline (FINAL WORKING)
...
EC2 → http://13.x.x.x:5000
⚠️ 5. IMPORTANT (Don’t miss this)

If using AWS EC2, open port:
...
# Logs
cat app.log
🧠 7. What You Achieved (Interview Ready)
CI/CD using Jenkins ✔
Python virtual env ✔
Flask deployment ✔
...
If you want next step (real DevOps level 🚀):
